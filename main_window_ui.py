...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        MainWindow.setTabOrder(self.inputDiag, self.ginputRadio)
        ...
        MainWindow.setTabOrder(self.bounFileInput, self.inputCoverage)
